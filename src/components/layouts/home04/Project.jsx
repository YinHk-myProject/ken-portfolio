                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-6">
                            <div className="content-inner animate-element wow delay5 fadeInUp" data-wow-delay="0.5s">
                                <h2 className="title mg-b14 color-d11">That is me!</h2>
                                <img src="images/me.png" alt="images" />
                                <div className="site-list has-border">
                                    ...
                                    <Link to="#" className="bg-s3"><i className="fa fa-twitter" aria-hidden="true" /></Link>
                                </div>
                            </div>
                        </div>
                    </div>
